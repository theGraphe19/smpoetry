...
<body class="demo">
	...
	<?php   
			...
			$o = $_SESSION['order_id']; //$_SESSION['order_id'];
		...
		<form class="form">
			...
			<article>
				...
				<table class="inventory" cellspacing="0px" cellpadding="0px">
					...
					<tbody>
						<tr>
							...
							<td align="center"><span>₹ 4500.00</span></td>
				...
				<table class="balance">
					...
					<tr>
						<th colspan="2"><span>Payment ID</span></th>
						<td colspan="3"><span><?php echo $row['razorpay_payment_id']; ?></span></td>
					</tr>
				</table>
			</article>
			<footer style="">
...
<script>  
    ...
    <script>
	    function myFunction() {
	        setTimeout("location.href = '../thankyou.php';",3500);
	    }
	</script>
</body>
</html>