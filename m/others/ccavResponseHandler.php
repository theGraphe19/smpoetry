<?php
	...
	if($order_status==="Success")
	{
        ...
        $subject = "New Order";
        $txt = "New international order recieved.";
        $headers = "From: info@smpoetry.com";
        mail($to,$subject,$txt,$headers);
		
		echo "<script>location.href='https://smpoetry.com/m/others/invoice/'</script>";
	...
	else if($order_status==="Aborted")
	{
		...
		echo "<script>location.href='https://smpoetry.com/m/others/aborted.html'</script>";
	...
	{	
		...
		echo "<script>location.href='https://smpoetry.com/m/others/failure.html'</script>";
	}
	else
	{
		echo "<script>alert('Something went wrong. Try again.');</script>";
		echo "<script>location.href='https://smpoetry.com/m/others/fault.html'</script>";
