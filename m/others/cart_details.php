   ...
   switch($_POST["action"]) {
       case "add":
        if(!empty($_POST["quantity"])) {
               $productByCode = $db_handle->runQuery("SELECT * FROM other_product WHERE code='" . $_POST["code"] . "'");
               ...
               if(!empty($_SESSION["cart_items"])) {
                       ...
                       foreach($_SESSION["cart_items"] as $k => $v) {
                               if($productByCode[0]["code"] == $k) {
                                   if(empty($_SESSION["cart_items"][$k]["quantity"])) {
                                       ...
                                       $_SESSION["cart_items"][$k]["delivery_country"] = $_POST["country_name"];
                                    $_SESSION["cart_items"][$k]["delivery_price"] = 0;
                                   }
                ...
                $_SESSION['dev_price'] = $_POST['country_price'];
                $_SESSION['dev_country'] = $_POST['country_name'];
...
<?php       
   foreach ($_SESSION["cart_items"] as $item)
   {
       ...
       $del_price = $item["quantity"] * $_SESSION['dev_price'];
...
<div class="container" style="padding-left:5vw;padding-right:5vw;width: 100%;top:0%;">
   <div class="row cart_prod" style="margin-top: 15vh;">
      ...
      <div class="col-md-4 cart_prod_det">
         ...
         <p><b>Delivery :</b>$  <?php echo $_SESSION['dev_price']; ?> <span style="font-size: 1rem">X</span> <?php echo $item["quantity"]; ?></p>
      </div>
      <div class="col-md-2 text-center">
         <a id="clear" class="align-middle" href="order_book.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction">
         <img src="https://smpoetry.com/m/others/assets/images/icon-delete.png" alt="Remove Item" />
         </a>
      </div>
   </div>
   <?php
        $total_prc = $item_price + $del_price;
   ?>
   <div class="cart_footer text-center" style="
      ...
      <div class="col-md-7" style="padding-top:3%;padding-bottom:3%;height:100%;" >
         ...
         <p class="" style="vertical-align:middle;margin:0px;"><b>Total : </b><?php echo "$  ". number_format($total_prc,2); ?></p>
      </div>
   ...
   <?php
      ...
      $total_price += ($item["price"]*$item["quantity"]+$del_price);
