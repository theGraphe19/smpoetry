<?php
        ...
        $o = $_SESSION['order_id'];
        $query2 = "select bill_email from order_details where order_id = '$o'";
        ...
        <tr>
        <td align="center" width="100%">
        <div style="position: relative;"><img class="img-responsive" style="position: relative;" src="https://smpoetry.com/m/others/assets/images/thanku.gif" />
        <div style="left: 40%; background-color: #e5e6e7;"><a href="https://www.instagram.com/_smpoetry_/"><img class="img-responsive" style="position: relative; display: unset;" src="https://smpoetry.com/m/others/assets/images/insta.png" /></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="https://twitter.com/_smpoetry_"><img class="img-responsive" style="position: relative; display: unset;" src="https://smpoetry.com/m/others/assets/images/twitter.png" /></a></div>
        </div>
        </td>
        </tr>
        </tbody>
...
<body>
    <section>
         <header class="header" style=" background-color: rgba(0,0,0,1);">
            ...
            <a class="logo poemp" style="letter-spacing:0vw ;" data-scroll="poems" href="https://smpoetry.com/m/">poems & quotes</a>
    ...
    <div class=container4>
        ...
        <br>
        <br>
        <a href="https://smpoetry.com/m/">
            <img src="https://smpoetry.com/m/others/assets/images/sm.png" style="width: 100%;">
        </a>
    </div>
