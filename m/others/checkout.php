...
<html lang="en-US">
   ...
   <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" rel="stylesheet">
      ...
      <link id="color-scheme" href="https://smpoetry.com/m/others/assets/css/colors/default.css" rel="stylesheet" />
      <link id="color-scheme" href="https://smpoetry.com/m/others/assets/css/mobile.css" rel="stylesheet" />
   ...
   <!-- <script>
      ...
      {
         var a = document.forms["fname"]["bill_name"].value;
         var b = document.forms["fname"]["bill_email"].value;
         var c = document.forms["fname"]["bill_tel"].value;
         var d = document.forms["fname"]["bill_address"].value;
         var e = document.forms["fname"]["bill_city"].value;
         var f = document.forms["fname"]["bill_zip"].value;
         var g = document.forms["fname"]["bill_state"].value;

         var h = document.forms["fname"]["ship_name"].value;
         var i = document.forms["fname"]["ship_email"].value;
         var j = document.forms["fname"]["ship_tel"].value;
         var k = document.forms["fname"]["ship_address"].value;
         var l = document.forms["fname"]["ship_city"].value;
         var m = document.forms["fname"]["ship_zip"].value;
         var n = document.forms["fname"]["ship_state"].value;
                     ...
                     <div class="container" style="width: 97%">
                        ...
                        <div class="row" style="margin-bottom: 50px">
                           <div class="col-sm-6 col-xs-6">
                              ...
                              <input type="text" name="billing_state" id="bill_state" class="form-control" required>
                           </div>
                           <div class="col-sm-6 col-xs-6">
                              <label for="bill_country">Country</label>
                              <select name="billing_country" id="bill_country" class="form-control">
               ...
               <div class="col-lg-6">
                  <div class="" style="background: #fff;">
                     ...
                     <div class="container" style="width: 97%" id="ship_box">
                        ...
                        <div class="row" style="margin-bottom: 10px">
                           <div class="col-sm-12">
                              <label for="ship_address">Address (Street & Area)</label>
                        ...
                        <div class="row" style="margin-bottom: 50px">
                           <div class="col-sm-6 col-xs-6">
                              ...
                              <input type="text" name="delivery_state" id="ship_state" class="form-control">
                           </div>
                           <div class="col-sm-6 col-xs-6">
                              <label for="ship_country">Country</label>
                              <input type="text" name="delivery_country" id="ship_country" value="<?php echo $_SESSION['dev_country']; ?>" class="form-control" readonly>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-lg-12">
                     <center>
                        ...
                        <input type="text" name="redirect_url" value="https://smpoetry.com/m/others/ccavResponseHandler.php" hidden/>
                        <input type="text" name="cancel_url" value="https://smpoetry.com/m/others/ccavResponseHandler.php" hidden/>
                        ...
                        <a href="https://smpoetry.com/m/others/order_book.php">
                           <input value="Back" type="button" class="btn btn-lg btnstyle" style="margin-top: 50px; width:74px;">
                        </a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="submit" name="ordbtn" value="Pay" class="btn btn-lg btnstyle" style="width:74px; margin-top: 50px;">
                     </center>
                  </div>
                  
                  <center><h5 style="color: #fff">Payment Options</h5></center>
                  <br>
                  <style>.slick-slide img {margin: 0px auto !important; width: 10vh !important;}</style>
                  <section class="customer-logos slider" style="margin-top: 0px !important;">
                     <div class="slide text-center"><img src="https://smpoetry.com/m/others/assets/images/logo/master.png"></div>
                     <div class="slide text-center"><img src="https://smpoetry.com/m/others/assets/images/logo/visa.png"></div>
                     <div class="slide text-center"><img src="https://smpoetry.com/m/others/assets/images/logo/net_banking.png"></div>
                  </section>
               </div>
            </form>
         </div>
