    ...
    case "remove":
        if(!empty($_SESSION["cart_item"])) {
            foreach($_SESSION["cart_item"] as $k => $v) {
               ...
               header('Location: https://smpoetry.com/m/order_book.php');
        }
    break;
    case "empty":
        unset($_SESSION["cart_item"]);
...
<head>
      <link rel="stylesheet" type="text/css" href="https://smpoetry.com/m/sliderstyle.css"/>
      <link href="https://smpoetry.com/m/assets/css/mobile.css" rel="stylesheet" />
      ...
      <script type="text/javascript" src="https://smpoetry.com/m/slider.jquery.js"></script>
   ...
   <body style="background:rgba(255,255,255,0);">
      ...
      <div class="main_con">
         ...
         <section>
            ...
            <div class="container">
               ...
               <!--   <img width="100%" height="100%" src="https://smpoetry.com/m/assets/images/PNG.png"class="right"/>-->
               <!--   <img width="100%" height="100%" src="https://smpoetry.com/m/assets/images/PNG2.png" class="left"/>-->
               <!--   <img width="100%" height="100%" src="https://smpoetry.com/m/assets/images/she1.png" class="center"/>-->
               <!--</section>-->
            ...
            <div class="container prod_details">
               ...
               <div class=" prod_det row text-center" style="font-size: 1.8rem;font-family: 'Helvetica';"  class="row prod_det text-center">
                  <b><?php echo "₹  ".$product_array[$key]["price"]; ?></b>
               </div>
               <div class=" prod_det row text-center">
                        <center>
                        <form>
                           <div class="input-group" style="width: 41vh">
                              <input id="check_pin" name="check_pin" type="text" class="form-control" 
                                 placeholder="Check Availabilty : Enter your PIN code" style="border-bottom: 1px solid black; border: top; 
                                       border-top: 0; border-radius: 0; box-shadow: none; border-left: 0; text-align: center;" required>
                              <span class="input-group-btn">
                                 <input type="button" value="Check" class="btn btn-md btnstyle" onclick="submit_soap()">
                              </span>
                           </div>
                        </form>
                           </center>
                        <div id="json_res" style="padding: 3vh 0 3vh 0; font-size: 1.3rem; font-family: 'Helvetica'"></div>
                     </div>
               <div class=" prod_det row text-center">
               ...
               <div class="row text-center">
                  <form name="fname" id="localStorage" action="https://smpoetry.com/m/pay/index.php" method="post" encytype="multipart/form-data">
                     <input name="total_price" value="<?php echo $total_price; ?>" hidden>
                  </form>
               </div>
            </div>
            <br><br><br><br>
      ...
      <!--  JavaScripts =============================================-->
         <!-- <script src="https://smpoetry.com/test/assets/lib/wow/dist/wow.js"></script>
            --><script src="https://smpoetry.com/m/assets/lib/bootstrap/dist/js/bootstrap.min.js"></script>
