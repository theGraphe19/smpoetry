<?php
   ...
   if(isset($_POST['other_chkout']))
   {  
      $o_con = isset($_POST['other_store_con']) ? $_POST['other_store_con'] : '' ;
      $o_quant = isset($_POST['other_store_quantityss']) ? $_POST['other_store_quantityss'] : '' ;
      $o_total_price = isset($_POST['other_store_totalss']) ? $_POST['other_store_totalss'] : '' ;

      $del_price = $o_total_price - ( 90 * $o_quant) ;

      $_SESSION['o_del_con'] = $o_con;
      $_SESSION['o_quantity'] = $o_quant;
      $_SESSION['o_total_price'] = $o_total_price;
      $_SESSION['o_delivery_price'] = $del_price;

      
      if(empty($_SESSION['o_del_con']))
      {
         echo "<script>alert('Select Shipping Country for Shipping Charge!');</script>";
   ...
   {
      if(empty($_SESSION['o_quantity']) && empty($_SESSION['o_total_price']))
      {
         unset($_SESSION['o_quantity']);
         unset($_SESSION['o_total_price']);
...
<html lang="en-US">
   <head>
      ...
      <style>
         .slick-slide img {opacity: 0.7; margin: 0px auto !important; width: 10vh !important;}
      ...
      <section style="margin-top: 3vh; margin-bottom: 3vh;">
         <div class="container">
                     ...
                     <div class="container" style="width: 97%" id="ship_box">
                        ...
                        <div class="row" style="margin-bottom: 50px">
                           ...
                           <div class="col-sm-6 col-xs-6">
                              ...
                              <input type="text" name="delivery_country" id="ship_country" value="<?php echo $_SESSION['o_del_con']; ?>" class="form-control" readonly>
                           </div>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-12 col-md-6 col-lg-6 text-center" style="padding: 1vh">
               ...
               <div class="col-12 col-md-6 col-lg-6 text-center" style="padding: 1vh">
                     ...
                     ?>
                     <form action="payment_response.php" method="post" encytype="multipart/form-data">
                        <script
                        ...
                        ></script>
                           ...
                           <input type="text" name="del_price" value="<?php echo $_SESSION['o_delivery_price']; ?>" readonly hidden>
                           ...
                           <input type="text" name="billing_country" id="bill_country" value="" readonly hidden>
                           ...
                           <input type="text" name="delivery_country" id="ship_country" value="<?php echo $_SESSION['o_del_con']; ?>" readonly hidden>
                     </form>
						</div>
      ...
      <section class="footer">
         <div class="row" style="margin-bottom: 2vh">
            <div class="col-lg-12">
               <div class="customer-logos slider" style="margin-top: 0px !important;">
                  <div class="slide text-center"><img src="assets/images/logo/master.png"></div>
                  <div class="slide text-center"><img src="assets/images/logo/visa.png"></div>
                  <div class="slide text-center"><img src="assets/images/logo/net_banking.png"></div>
               </div>
            </div>
         </div>
         ...
         <div>
            <footer class="copyright bg-dark">
               <span class="spans">Copyright © <?php echo date('Y'); ?>, by Shyam Malani. Designed by
